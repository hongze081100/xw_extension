...
import { installXhrAndFetchHook, addInterceptor } from '../utils/network';
...
installBridge();
installXhrAndFetchHook();

addInterceptor({
  onResponse(context) {
    console.log('====拦截请求响应：', context.request.url, Object.fromEntries(context.response.headers.entries()));
  },
})
